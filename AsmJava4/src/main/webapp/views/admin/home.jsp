		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item menu-open"><a href="admin/video?action=views" class="nav-link">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a href="admin/video?action=views"
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="form-group">
										...
										<option selected dissabled>Lựa chọn...</option>
											<c:forEach items="${videos}" var="item">
