...
<body class="hold-transition sidebar-mini layout-fixed">
	...
	<aside class="main-sidebar sidebar-dark-primary elevation-4">
		<!-- Brand Logo -->
		<a href="http://localhost:8081/asm-java4/index" class="brand-link"> <img
			src="<c:url value='/templates/admin/dist/img/AdminLTELogo.png'/>"
			alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
			style="opacity: .8"> <span
			class="brand-text font-weight-light">PhimCuaXuanTu</span>
		</a>
		...
		<div class="sidebar">
			...
			<nav class="mt-2">
              ...
              with font-awesome or any other icon font library -->
					...
					<li class="nav-item menu-open"><a href="<c:url value='/admin/video?action=views'/>" class="nav-link">
						...
						<ul class="nav nav-treeview">
							<li class="nav-item"><a href="<c:url value='/admin/video?action=views'/>"
									...
									<tbody>
										<c:forEach items="${videos}" var="item">
											<tr>
												...
												<td>
													<img alt="${item.title }" src="${item.poster }" width="150px" height="150px">
												</td>
												<td>
													<a href="<c:url value='/admin/video?action=edit&href=${item.href }'/>" type="button" class="btn btn-block btn-default btn-sm">EDIT</a>
													<button onclick="deleteVideo('${item.href}')" type="button" class="btn btn-block btn-info btn-sm">DELETE</button>
												</td>
											</tr>
										</c:forEach>
									</tbody>
 ...
 <script>
 	function deleteVideo(href){
 		$.ajax({
 			...
 			window.location.href = "http://localhost:8081/asm-java4/admin/video?action=views";
 		}).fail(function(error){
